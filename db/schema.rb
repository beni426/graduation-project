...
ActiveRecord::Schema.define(version: 20_220_410_111_038) do
  ...
  create_table 'conversations', force: :cascade do |t|
    ...
    t.index %w[sender_id receiver_id], name: 'index_conversations_on_sender_id_and_receiver_id', unique: true
  ...
  create_table 'votes', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[post_id user_id], name: 'index_votes_on_post_id_and_user_id'
